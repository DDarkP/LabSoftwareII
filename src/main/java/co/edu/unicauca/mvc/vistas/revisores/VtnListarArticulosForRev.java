...
import co.edu.unicauca.mvc.vistas.revisores.VtnRegistrarRevision;
...
//                JButtonEliminarArticulo,
    ...
    private void initComponents() {
        ...
        jButtonRegistrar.setText("Agregar comentario ");
        ...
        if(row < jTableListarArticulos.getRowCount() && row >= 0 && column < jTableListarArticulos.getColumnCount() && column >= 0){
            ...
            if(value instanceof JButton){
                ...
                if(boton.getName().equals("Eliminar")){
                    ...
                    VtnRegistrarRevision objVtnRegistrarRevision = 
                            new VtnRegistrarRevision(objServicio, objServicio2);
                    objVtnRegistrarRevision.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    objVtnRegistrarRevision.cargarDatos(idArticuloConvertido);
                    objVtnRegistrarRevision.setVisible(true);
